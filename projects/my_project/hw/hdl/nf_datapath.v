...
(
	...
	// TODO
	// ######################################
	// your module connectivity
	// ######################################
    wire [C_M_AXIS_DATA_WIDTH - 1:0]         m_axis_mymodule_tdata;
    wire [((C_M_AXIS_DATA_WIDTH / 8)) - 1:0] m_axis_mymodule_tkeep;
    wire [C_M_AXIS_TUSER_WIDTH-1:0]          m_axis_mymodule_tuser;
    wire                                     m_axis_mymodule_tvalid;
    wire                                     m_axis_mymodule_tready;
    wire                                     m_axis_mymodule_tlast;
 ...
 input_arbiter_v1_0 (
	...
	// ############################
     ...
     my_module  (
      .axis_aclk(axis_aclk), // input axi_aclk
      .axis_resetn(axis_resetn), // input axi_resetn
      .m_axis_tdata (m_axis_mymodule_tdata), // output [255 : 0] m_axis_tdata
      .m_axis_tkeep (m_axis_mymodule_tkeep), // output [31 : 0] m_axis_tkeep
      .m_axis_tuser (m_axis_mymodule_tuser), // output [127 : 0] m_axis_tuser
      .m_axis_tvalid(m_axis_mymodule_tvalid), // output m_axis_tvalid
      .m_axis_tready(m_axis_mymodule_tready), // input m_axis_tready
      .m_axis_tlast (m_axis_mymodule_tlast), // output m_axis_tlast
      ...
      .axis_aclk(axis_aclk), // input axi_aclk
      .axis_resetn(axis_resetn), // input axi_resetn
      .s_axis_tdata   (m_axis_mymodule_tdata), // input [255 : 0] s_axis_tdata
      .s_axis_tkeep   (m_axis_mymodule_tkeep), // input [31 : 0] s_axis_tkeep
      .s_axis_tuser   (m_axis_mymodule_tuser), // input [127 : 0] s_axis_tuser
      .s_axis_tvalid  (m_axis_mymodule_tvalid), // input s_axis_tvalid
      .s_axis_tready  (m_axis_mymodule_tready), // output s_axis_tready
      .s_axis_tlast   (m_axis_mymodule_tlast), // input s_axis_tlast

...
# user defined module
# ####################
create_ip -name my_module -vendor NetFPGA -library NetFPGA -module_name my_module_ip
set_property generate_synth_checkpoint false [get_files my_module_ip.xci]
reset_target all [get_ips my_module_ip]
generate_target all [get_ips my_module_ip]
